...
const NAV_CONFIG = [
  ...
  { id: 'write-streams',  section: '§4',     label: 'WRITE Streams',    href: 'write-streams.html' },
  { id: 'read-streams',   section: '§5',     label: 'READ Streams',     href: 'read-streams.html' },
...
const PAGE_DATA = {
  ...
  version: 'Interactive Outline · v0.1 draft',
